...
<head>
    ...
    <title>page_1779356057_51ff47</title>
...
<?php include __DIR__ . '/includes/header.php'; ?>
    ...
    <main id="main-content"><div class="page-content"><div class="image-module layout-normal"><img src="/uploads/20260514_6a05a0508afd2.jpg" alt="图片描述" style="width: 100%;" class="image-module-img"></div><div class="card-grid card-style-modern" style="grid-template-columns: repeat(4, 1fr);"><div class="card-item"><div class="card-image"><img src="/uploads/20260514_6a05a0508afd2.jpg" alt="卡片标题1" class="card-img"></div><div class="card-body"><h3 class="card-title">卡片标题1</h3><p class="card-description">卡片描述内容</p></div></div><div class="card-item"><div class="card-image"><img src="/uploads/20260514_6a05a0508afd2.jpg" alt="卡片标题2" class="card-img"></div><div class="card-body"><h3 class="card-title">卡片标题2</h3><p class="card-description">卡片描述内容</p></div></div><div class="card-item"><div class="card-image"><img src="/uploads/20260514_6a05a0508afd2.jpg" alt="卡片标题3" class="card-img"></div><div class="card-body"><h3 class="card-title">卡片标题3</h3><p class="card-description">卡片描述内容</p></div></div><div class="card-item"><div class="card-image"><img src="/uploads/20260514_6a05a0508afd2.jpg" alt="新卡片" class="card-img"></div><div class="card-body"><h3 class="card-title">新卡片</h3></div></div></div><div class="button-module" style="text-align: center;"><a href="#" class="btn btn-primary btn-medium" >点击按钮</a></div><div class="text-module" style="text-align: left;"><h2 class="module-title">标题文本</h2><div class="module-content">这里是内容文本，可以编辑修改。</div></div><div class="text-module" style="text-align: left;"><h2 class="module-title">标题文本</h2><div class="module-content">这里是内容文本，可以编辑修改。</div></div></div></main>
