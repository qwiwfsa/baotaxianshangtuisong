...
<nav class="navbar" id="navbar" role="navigation" aria-label="主导航">
    <div class="navbar-container">
        ...
        <button class="search-toggle" id="searchToggle" aria-label="打开搜索" aria-expanded="false" onclick="var so=document.getElementById('searchOverlay');if(so){so.classList.add('active');so.setAttribute('aria-hidden','false');this.setAttribute('aria-expanded','true');document.body.style.overflow='hidden';var si=document.getElementById('searchInput');if(si)setTimeout(function(){si.focus();},100);}">
