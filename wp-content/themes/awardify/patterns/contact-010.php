...
<figure class="wp-block-image size-large has-custom-border"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/contact/contact-10-5.jpg");?>" alt="" style="border-radius:16px"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<p class="has-text-align-left has-mono-2-color has-text-color has-superbfont-small-font-size">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam non nisl in velit dignissim mollis a rhoncus dolor. Vivamus egestas condimentum erat, in iaculis nulla blandit ut.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/contact/contact-10-1.png");?>" alt="" style="width:32px;height:32px"/></figure>
<!-- /wp:image -->
...
<p class="has-mono-2-color has-text-color has-superbfont-small-font-size">email@example.com</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column -->
...
<div class="wp-block-column"><!-- wp:image {"width":"32px","height":"32px","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/contact/contact-10-2.png");?>" alt="" style="width:32px;height:32px"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"textColor":"mono-2","fontSize":"superbfont-small"} -->
<p class="has-mono-2-color has-text-color has-superbfont-small-font-size">+1 (234) 567-8910</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns -->
...
<div class="wp-block-columns"><!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small"}}} -->
<div class="wp-block-column"><!-- wp:image {"width":"32px","height":"32px","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/contact/contact-10-3.png");?>" alt="" style="width:32px;height:32px"/></figure>
<!-- /wp:image -->
...
<!-- wp:column {"style":{"spacing":{"blockGap":"var:preset|spacing|xx-small"}}} -->
<div class="wp-block-column"><!-- wp:image {"width":"32px","height":"32px","sizeSlug":"large","linkDestination":"none"} -->
<figure class="wp-block-image size-large is-resized"><img src="<?php echo esc_url(get_template_directory_uri() . "/assets/images/contact/contact-10-4.png");?>" alt="" style="width:32px;height:32px"/></figure>
<!-- /wp:image -->
...
<!-- wp:paragraph {"textColor":"mono-2","fontSize":"superbfont-small"} -->
<p class="has-mono-2-color has-text-color has-superbfont-small-font-size">735 Plymouth Street<br>West Haven, CT 06516</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:column --></div>
<!-- /wp:columns --></div>
