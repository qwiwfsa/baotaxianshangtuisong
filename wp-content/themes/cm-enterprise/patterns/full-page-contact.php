<?php
/**
 * Title: Full Page Contact
 * Slug: cm-enterprise/full-page-contact
...
<div class="wp-block-group alignfull has-body-background-color has-background"><!-- wp:spacer {"height":"var:preset|spacing|40"} -->
    ...
    <h2 class="wp-block-heading has-text-align-center"><?php echo __( 'Contact Us', 'cm-enterprise' ); ?></h2>
    <!-- /wp:heading -->
    ...
    <!-- /wp:spacer --></div>
<!-- /wp:group -->
<!-- wp:pattern {"slug":"cm-enterprise/contact-info"} /-->
