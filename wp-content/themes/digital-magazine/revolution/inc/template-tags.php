...
if( !function_exists('digital_magazine_breadcrumbs') ) :
    /**
     * Digital Magazine Breadcrumbs Function
     */
    function digital_magazine_breadcrumbs($digital_magazine_comment = null){

        echo '<div class="digital-magazine-breadcrumbs">';
        	digital_magazine_breadcrumbs_trail();
        echo '</div>';
