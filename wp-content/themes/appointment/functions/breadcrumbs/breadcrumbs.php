...
function appointment_custom_breadcrumbs() {
  $appointment_breadcrumb_type = get_theme_mod('appointment_breadcrumb_type','default');
	if($appointment_breadcrumb_type == 'yoast') {
	...
	elseif($appointment_breadcrumb_type == 'navxt'){
    ...
    elseif($appointment_breadcrumb_type == 'rankmath') {
	if( function_exists( 'rank_math_the_breadcrumbs' ) )
	{
		rank_math_the_breadcrumbs();
	} 
    }
   elseif($appointment_breadcrumb_type == 'default') {
