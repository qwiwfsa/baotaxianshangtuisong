...
<div class="footer-copyright-section">
    <div class="container">
        <div class="row">
            ...
            if ($appointment_footer_setting['footer_menu_bar_enabled'] == 0 ) { ?>
                <div class="footer-copyright"><p>
                       <?php echo wp_kses_post($appointment_footer_setting['footer_copyright_text']);
                         echo ' | ' . sprintf( esc_html('Theme:%s by Webriti', 'appointment' ), '<a href="https://webriti.com/" rel="nofollow">' . ' ' . 'Appointment'. '</a>');  
						?>
                </p></div>
            <?php } // end if    ?>
            </div>
