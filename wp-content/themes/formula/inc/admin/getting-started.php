...
if (!function_exists('formula_getting_started_page')):
	...
	<div class="wrap getting-started">
		...
		printf(esc_html__('Welcome to %s', 'formula'), esc_html(FORMULA_THEME_NAME));
?>
				</h3>
				<span class="theme-version">
					<?php
		/* translators: %s: theme version */
		printf(esc_html__('Version %s', 'formula'), esc_html(FORMULA_THEME_VERSION));
?>
				</span>
				<span class="theme-version elementor-badge" style="background: rgba(255,255,255,0.2); margin-left: 10px;">
					<?php esc_html_e('Elementor Compatible', 'formula'); ?>
				</span>
				...
				<a class="button button-hero-upgrade" href="https://awplife.com/wordpress-themes/formula-premium/" target="_blank">
...
?>
				...
				<li>
					<a id="free-vs-pro-panel" href="#">
						<span class="dashicons dashicons-star-filled pro-tab-icon"></span>
						<?php esc_html_e('Free vs Pro', 'formula'); ?>
					</a>
				</li>
				<li>
					<a id="sync-to-premium-panel" href="#">
						<span class="dashicons dashicons-update sync-tab-icon"></span>
			...
			<div id="panel" class="panel">
					...
					<?php require get_template_directory() . '/inc/admin/tabs/sync-to-premium-panel.php'; ?>
			</div>
		</div>
	</div>
		<?php
