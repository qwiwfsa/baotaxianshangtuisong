...
?>
	...
	<!-- Demo Import Card -->
	<div class="panel-aside panel-column">
		<h4><?php esc_html_e('Import Demo Content', 'formula'); ?></h4>
		<p><?php esc_html_e('Import pre-built demos to quickly set up your website with sample content, layouts, and settings. Make sure the One Click Demo Import plugin is installed and activated.', 'formula'); ?></p>
		<a class="button button-primary" href="<?php echo esc_url(admin_url('themes.php?page=one-click-demo-import')); ?>"><?php esc_html_e('Import Demo', 'formula'); ?></a>
	</div>
</div>