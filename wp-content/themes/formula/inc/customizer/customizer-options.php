...
add_action( 'after_setup_theme', 'formula_register_customizer_notify' );

function formula_register_customizer_notify() {
	...
	formula_Customizer_Notify::init(
		apply_filters( 'formula_customizer_notify_array', $formula_config_customizer )
	);
}
