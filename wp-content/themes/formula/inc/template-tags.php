			...
			if (is_home() || is_front_page()) :
					echo '<li><a href="'.esc_url($homeLink).'">'.esc_html__('Home','formula').'</a></li>';
						...
						elseif ( is_page() && $post->post_parent ) {
							...
							foreach ($breadcrumbs as $crumb) echo wp_kses_post( $crumb );
							echo '<li class="active"><a href="' . esc_url( formula_page_url() ) . '">'. esc_html( get_the_title() ) .'</a></li>';
                        }
						elseif( is_search() )
						{
							echo '<li class="active"><a href="' . esc_url( formula_page_url() ) . '">'. esc_html( get_search_query( false ) ) .'</a></li>';
						}
						elseif( is_404() )
						{
			...
			<div class="updated notice notice-get-started-class is-dismissible" data-notice="get_started">
					<div class="formula-getting-started-notice clearfix">
						...
						<div class="formula-theme-notice-content">
							...
							<p class="plugin-install-notice"><?php esc_html_e( 'To begin the installation process, activation, and importing of demo data, simply click the Get Started button.', 'formula' ); ?></p>

							<a class="formula-btn-get-started button button-primary button-hero" href="#" data-name="" data-slug="">
							<?php
							printf(
							/* translators: 1: welcome page link starting html tag, 2: welcome page link ending html tag. */
