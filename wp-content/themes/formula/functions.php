...
function formula_backend_resources()
{
	...
	// Google Fonts are handled by inc/customizer/webfont.php

	// Comment reply enable.
	wp_enqueue_script('comment-reply');

	// Formula js.
	wp_enqueue_script('bootstrap-js', FORMULA_THEME_URL . '/assets/js/bootstrap.js', array('jquery'), false, true);
	wp_enqueue_script('jquery');
	wp_enqueue_script('imagesloaded');
	wp_enqueue_script('masonry');

	wp_enqueue_script('appear-min', FORMULA_THEME_URL . '/assets/vendors/jquery-appear/jquery.appear.min.js', '', false, true);
	wp_enqueue_script('easing-min', FORMULA_THEME_URL . '/assets/vendors/jquery-easing/jquery.easing.min.js', '', false, true);
	wp_enqueue_script('bootstrap-bundle-min', FORMULA_THEME_URL . '/assets/vendors/bootstrap/js/bootstrap.bundle.min.js', '', false, true);

	// Animation Js.
	if (get_theme_mod('formula_animation_disabled', true) == true):
		wp_enqueue_script('wow', FORMULA_THEME_URL . '/assets/vendors/wow/wow.js', '', false, true);
	endif;

	wp_enqueue_script('owl-carousel-min', FORMULA_THEME_URL . '/assets/vendors/owl-carousel/owl.carousel.min.js', '', false, true);
	wp_enqueue_script('appear-min', FORMULA_THEME_URL . '/assets/vendors/jquery-appear/jquery.appear.min.js', '', false);
	wp_enqueue_script('odometer-min', FORMULA_THEME_URL . '/assets/vendors/odometer/odometer.min.js', '', false, true);
	wp_enqueue_script('formula-main', FORMULA_THEME_URL . '/assets/js/formula.js', '', false, true);
...
if (is_admin()) {
	...
	require FORMULA_THEME_DIR . '/inc/admin/deactivation-feedback.php';
}
//}
 ...
 * Sync Settings Class
 */
require FORMULA_THEME_DIR . '/inc/customizer/class-formula-customize-sync.php';
