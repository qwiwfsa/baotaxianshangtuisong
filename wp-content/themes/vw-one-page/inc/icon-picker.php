...
class VW_One_Page_Fontawesome_Icon_Chooser extends WP_Customize_Control{
    public $type = 'icon';
        ...
        ?>
            <label>
                ...
                <div class="social-icon-search">
                    <input class="socialInput" type="text" placeholder="<?php echo esc_attr_x( 'Icon', 'placeholder', 'vw-one-page' ); ?>">
                </div>
                ...
                <ul class="icon-list clearfix">
                    <?php
                    $vw_one_page_font_awesome_icon_array = vw_one_page_font_awesome_icon_array();
                    foreach ($vw_one_page_font_awesome_icon_array as $vw_one_page_font_awesome_icon) {
                            $icon_class = $this->value() == $vw_one_page_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($vw_one_page_font_awesome_icon).'"></i>
                            <span class="vw-one-page-social-class">'.esc_attr($vw_one_page_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                </ul>
...
function vw_one_page_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
    wp_enqueue_script( 'vw-one-page-customizer-script', esc_url(get_template_directory_uri()).'/js/customizer-scripts.js', array("jquery"),'', true  );
}
add_action( 'customize_controls_enqueue_scripts', 'vw_one_page_customizer_script' );

if(!function_exists('vw_one_page_font_awesome_icon_array')){
    function vw_one_page_font_awesome_icon_array(){
