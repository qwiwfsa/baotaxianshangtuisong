...
<div class="title-box">
    <div class="container">
        <h2 class="entry-title"><?php echo esc_html(get_theme_mod('vw_one_page_no_results_page_title',__('Nothing Found','vw-one-page')));?></h2>
    </div>
</div>
...
<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
	...
	<p><?php echo esc_html(get_theme_mod('vw_one_page_no_results_page_content',__('Sorry, but nothing matched your search terms. Please try again with some different keywords.','vw-one-page')));?></p><br />
		<?php get_search_form(); ?>
	<?php else : ?>
