jQuery(document).ready(function($) {
    'use strict';
    var this_obj = vw_one_page_plugin_activate_plugin;

    $(document).on('click', '.vw-one-page-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message vw-one-page-plugin-install');
                button.addClass('button-primary vw-one-page-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.vw-one-page-recommended-plugins .vw-one-page-activation-note').css('display','block');
    ...
    $(document).on('click', '.vw-one-page-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .vw-one-page-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .vw-one-page-recommended-plugins').css('display','none');
    });
