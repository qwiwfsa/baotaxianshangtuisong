...
if ( ! function_exists( 'castell_posted_on' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time.
	 */
	function castell_posted_on() {
...
if ( ! function_exists( 'castell_posted_by' ) ) :
	/**
	 * Prints HTML with meta information for the current author.
	 */
	function castell_posted_by() {
		$byline = sprintf(
			/* translators: %s: post author. */
			esc_html( '%s', 'post author', 'castell' ),
...
if ( ! function_exists( 'castell_post_comments' ) ) :
	/**
	 * Prints HTML with meta information for the current post-date/time and author.
	 */
	function castell_post_comments() {
...
if ( ! function_exists( 'castell_entry_footer' ) ) :
	/**
	 * Prints HTML with meta information for the categories, tags and comments.
	 */
	function castell_entry_footer() {
...
if ( ! function_exists( 'castell_post_thumbnail' ) ) :
	/**
	 ...
	 */
	function castell_post_thumbnail() {
...
if( ! function_exists( 'castell_fontawesome_social_icons_lists' ) ) :
	/**
     * Font Awesome
     *
	...
	function castell_fontawesome_social_icons_lists() {
