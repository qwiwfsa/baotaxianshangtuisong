...
if ( ! class_exists( 'Advance_Blogging_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Advance_Blogging_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'advance_blogging_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function advance_blogging_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Advance_Blogging_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'advance_blogging_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function advance_blogging_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new Advance_Blogging_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
