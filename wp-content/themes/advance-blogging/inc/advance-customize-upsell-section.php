 ...
 */
/**
 * Class Advance_Blogging_Customizer_Upsell_Section
 */
class Advance_Blogging_Customizer_Upsell_Section extends WP_Customize_Section {
	/**
	...
	/**
	 * Advance_Blogging_Customizer_Upsell_Section constructor.
	 */
	public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
		$manager->register_section_type( 'Advance_Blogging_Customizer_Upsell_Section' );
