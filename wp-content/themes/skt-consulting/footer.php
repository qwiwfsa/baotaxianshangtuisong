...
<div class="container">
     <div class="copyright-txt"><?php bloginfo('name'); ?> <?php esc_html_e('Theme By ','skt-consulting');?> <a href="<?php echo esc_url('https://www.sktthemes.org/shop/free-financial-wordpress-theme/');?>" rel="noopener" target="_blank">
        <?php esc_html_e('SKT Consulting','skt-consulting'); ?>
        </a></div>
     <div class="clear"></div>
</div>           
</div>
