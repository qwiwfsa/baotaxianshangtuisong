 ...
 * Slug: sky-enterprise/testimonial-section
...
<div class="wp-block-group has-light-color-background-color has-background" style="margin-top:0px;margin-bottom:0px;padding-top:100px;padding-right:var(--wp--preset--spacing--40);padding-bottom:100px;padding-left:var(--wp--preset--spacing--40)"><!-- wp:columns {"style":{"spacing":{"margin":{"top":"0px"},"blockGap":{"left":"30px"}}}} -->
    <div class="wp-block-columns" style="margin-top:0px"><!-- wp:column {"className":"sky-enterprise-fade-up"} -->
        <div class="wp-block-column sky-enterprise-fade-up"><!-- wp:group {"style":{"border":{"radius":"12px","width":"1px","color":"#E5EBFF"},"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"}}},"className":"sky-enterprise-hover-box","layout":{"type":"constrained"}} -->
            <div class="wp-block-group sky-enterprise-hover-box has-border-color" style="border-color:#E5EBFF;border-width:1px;border-radius:12px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:paragraph -->
                <p><?php esc_html_e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'sky-enterprise') ?></p>
                <!-- /wp:paragraph -->
        ...
        <div class="wp-block-column sky-enterprise-fade-up"><!-- wp:group {"style":{"border":{"radius":"12px","width":"1px","color":"#E5EBFF"},"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"}}},"className":"sky-enterprise-hover-box","layout":{"type":"constrained"}} -->
            <div class="wp-block-group sky-enterprise-hover-box has-border-color" style="border-color:#E5EBFF;border-width:1px;border-radius:12px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:paragraph -->
                ...
                <div class="wp-block-group"><!-- wp:image {"id":2415,"width":"auto","height":"60px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"0"}}} -->
                    ...
                    <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group"><!-- wp:heading {"level":5,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
                        <h5 class="wp-block-heading" style="font-style:normal;font-weight:600"><?php esc_html_e('Liyaza Turner', 'sky-enterprise') ?></h5>
                        <!-- /wp:heading -->

                        <!-- wp:paragraph -->
                        <p><?php esc_html_e('Traveller', 'sky-enterprise') ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
        ...
        <div class="wp-block-column sky-enterprise-fade-up"><!-- wp:group {"style":{"border":{"radius":"12px","width":"1px","color":"#E5EBFF"},"spacing":{"padding":{"top":"30px","bottom":"30px","left":"30px","right":"30px"}}},"className":"sky-enterprise-hover-box","layout":{"type":"constrained"}} -->
            <div class="wp-block-group sky-enterprise-hover-box has-border-color" style="border-color:#E5EBFF;border-width:1px;border-radius:12px;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px"><!-- wp:paragraph -->
                ...
                <div class="wp-block-group"><!-- wp:image {"id":2415,"width":"auto","height":"60px","aspectRatio":"1","scale":"cover","sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"0"}}} -->
                    ...
                    <!-- wp:group {"style":{"spacing":{"blockGap":"0"}},"layout":{"type":"flex","orientation":"vertical"}} -->
                    <div class="wp-block-group"><!-- wp:heading {"level":5,"style":{"typography":{"fontStyle":"normal","fontWeight":"600"}}} -->
                        <h5 class="wp-block-heading" style="font-style:normal;font-weight:600"><?php esc_html_e('Patrick Pomelo', 'sky-enterprise') ?></h5>
                        <!-- /wp:heading -->

                        <!-- wp:paragraph -->
                        <p><?php esc_html_e('Vlogger', 'sky-enterprise') ?></p>
                        <!-- /wp:paragraph -->
                    </div>
                    <!-- /wp:group -->
                </div>
