...
* Added hover for single post page.
...
* Resolved error for demo import tab.
...
* Fixed security: added nonce verification to dismissable notice and ajax notice handler.
...
* Fixed incorrect esc_attr() usage in comment date/time display in template-tags.php.
* Fixed orphaned closing div in index.php.
