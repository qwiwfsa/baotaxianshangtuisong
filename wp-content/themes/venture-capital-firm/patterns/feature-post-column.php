 ...
 * Slug: venture-capital-firm/feature-post-column
 * Categories: template
 */
?>
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Popular News', 'venture-capital-firm' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
			...
			>
				...
				>
					...
					<h3
						...
						"
					>
					<?php echo esc_html__( 'Recent News', 'venture-capital-firm' ); ?>
					</h3>
					<!-- /wp:heading -->
				</div>
				<!-- /wp:group -->
