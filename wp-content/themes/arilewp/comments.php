...
<?php if ( post_password_required() ) : ?>
	...
	<?php if ( get_option('comment_registration') && !is_user_logged_in() ) : ?>
		...
		echo sprintf( __( 'You must be <a href="%s">logged in</a> to post a comment','arilewp' ), esc_url(home_url( 'wp-login.php' ) . '?redirect_to=' .  urlencode(get_permalink()))); ?></p></article>
</p>
<?php else : ?>
