...
class Vancura_Loader {
	 ...
	 * @return void
	 */
	public function vancura_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function vancura_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function vancura_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function vancura_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->vancura_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function vancura_load( $class ) {
