...
class Vancura_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4{
    private static $loader;

    public static function vancura_loadClassLoader($class)
    {
    ...
    public static function vancura_getLoader(){
        if (null !== self::$loader) {
            return self::$loader;
        }

        spl_autoload_register(array('Vancura_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4', 'vancura_loadClassLoader'), true, true);
        self::$loader = $loader = new \Composer\Autoload\ClassLoader();
        spl_autoload_unregister(array('Vancura_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4', 'vancura_loadClassLoader'));
