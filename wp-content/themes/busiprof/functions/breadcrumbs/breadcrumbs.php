...
function busiprof_custom_breadcrumbs() {
  ...
  $busiprof_breadcrumb_type = get_theme_mod('busiprof_breadcrumb_type','default');
	if($busiprof_breadcrumb_type == 'yoast') {
	...
	elseif($busiprof_breadcrumb_type == 'navxt'){
    ...
    elseif($busiprof_breadcrumb_type == 'rankmath') {
	if( function_exists( 'rank_math_the_breadcrumbs' ) )
	{
		rank_math_the_breadcrumbs();
	} 
    }
elseif($busiprof_breadcrumb_type == 'default') {
