...
class SAAS_Software_Loader {
	 ...
	 * @return void
	 */
	public function saas_software_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function saas_software_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function saas_software_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function saas_software_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->saas_software_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function saas_software_load( $class ) {
