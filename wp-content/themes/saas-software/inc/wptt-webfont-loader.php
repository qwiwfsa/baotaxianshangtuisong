...
if ( ! class_exists( 'SAAS_Software_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class SAAS_Software_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'saas_software_wptt_get_webfont_styles' ) ) {
	/**
	 ...
	 */
	function saas_software_wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new SAAS_Software_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_styles();
	}
}

if ( ! function_exists( 'saas_software_wptt_get_webfont_url' ) ) {
	/**
	 ...
	 * @return string Returns the CSS.
	 */
	function saas_software_wptt_get_webfont_url( $url, $format = 'woff2' ) {
		$font = new SAAS_Software_WPTT_WebFont_Loader( $url );
		$font->set_font_format( $format );
		return $font->get_url();
	}
