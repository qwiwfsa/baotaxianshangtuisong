		...
		function() {
			...
			api.section.each(
				function( section ) {
					...
					if (
					'awpbusinesspress_section' !== section.params.type ||
			...
			api.panel.each(
				function( panel ) {
					...
					if (
					'awpbusinesspress_panel' !== panel.params.type ||
	...
	wp.customize.Panel = wp.customize.Panel.extend(
		{
			attachEvents        : function() {
				...
				if (
					'awpbusinesspress_panel' !== this.params.type ||
	...
	wp.customize.Section = wp.customize.Section.extend(
		{
			attachEvents        : function() {
				...
				if (
					'awpbusinesspress_section' !== this.params.type ||
