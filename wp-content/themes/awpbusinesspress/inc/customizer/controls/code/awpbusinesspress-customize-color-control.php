...
/**
 * Class awpbusinesspress_Customize_Color_Control
 */
class awpbusinesspress_Customize_Color_Control extends awpbusinesspress_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'awpbusinesspress-color';
