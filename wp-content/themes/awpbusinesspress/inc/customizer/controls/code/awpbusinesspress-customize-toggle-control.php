...
/**
 * Class awpbusinesspress_Customize_Toggle_Control
 */
class awpbusinesspress_Customize_Toggle_Control extends awpbusinesspress_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'awpbusinesspress-toggle';
