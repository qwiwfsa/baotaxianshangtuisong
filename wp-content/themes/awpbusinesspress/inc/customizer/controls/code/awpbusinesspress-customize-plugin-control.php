...
if ( class_exists( 'WP_Customize_Section' ) ) :
	 ...
	 */
	class awpbusinesspress_Customize_Recommended_Plugin_Section extends WP_Customize_Section {
		 ...
		 * @var    string
		 */
		public $type = 'awpbusinesspress-plugin-section';
