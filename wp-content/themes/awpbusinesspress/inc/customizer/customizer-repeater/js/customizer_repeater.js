/* global jQuery */
/* global wp */
function awpbusinesspress_media_upload(button_class) {
	'use strict';
	jQuery( 'body' ).on(
		'click',
		button_class,
 ...
 * ** Generate unique id ***
 *********************************************/
function awpbusinesspress_customizer_repeater_uniqid(prefix, more_entropy) {
	'use strict';
 ...
 * ** General Repeater ***
 *********************************************/
function awpbusinesspress_customizer_repeater_refresh_social_icons(th) {
	'use strict';
	...
	th.find( '.customizer-repeater-social-repeater-container' ).each(
		function () {
			...
			if ( ! id) {
				id = 'customizer-repeater-social-repeater-' + awpbusinesspress_customizer_repeater_uniqid();
	...
	awpbusinesspress_customizer_repeater_refresh_general_control_values();
}


function awpbusinesspress_customizer_repeater_refresh_general_control_values() {
		...
		function () {
			...
			th.find( '.customizer-repeater-general-control-repeater-container' ).each(
				function () {
					...
					if ( ! id) {
						id = 'social-repeater-' + awpbusinesspress_customizer_repeater_uniqid();
						...
						values.push(
							{
								...
								'color': color,
								'text': awpbusinesspress_escapeHtml( text ),
								'link': link,
								'image_url': (choice === 'customizer_repeater_none' ? '' : image_url),
								'choice': choice,
								'title': awpbusinesspress_escapeHtml( title ),
								'subtitle': awpbusinesspress_escapeHtml( subtitle ),
								'social_repeater': awpbusinesspress_escapeHtml( social_repeater ),
								'id': id,
								'shortcode': awpbusinesspress_escapeHtml( shortcode ),
...
jQuery( document ).ready(
	function () {
		...
		awpbusinesspress_media_upload( '.customizer-repeater-custom-media-button' );
		...
		theme_conrols.on(
			...
			function () {
				...
				if (parentid == 'customize-control-awpbusinesspress_main_slider_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_main_slider_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 2) {
						jQuery( "#customize-control-awpbusinesspress_slider_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_top_info_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_top_info_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-awpbusinesspress_top_info_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_service_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_service_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-awpbusinesspress_service_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_funfact_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_funfact_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-awpbusinesspress_funfact_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_team_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_team_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-awpbusinesspress_team_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_project_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_project_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 4) {
						jQuery( "#customize-control-awpbusinesspress_project_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_testimonial_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_testimonial_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 3) {
						jQuery( "#customize-control-awpbusinesspress_testimonial_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}
				if (parentid == 'customize-control-awpbusinesspress_client_content') {
					var numItems = jQuery( "#customize-control-awpbusinesspress_client_content .customizer-repeater-general-control-repeater-container" ).length
					if (numItems >= 4) {
						jQuery( "#customize-control-awpbusinesspress_client_upgrade .awpbusinesspress-upgrade-pro-message" ).show();
						return false;
					}
				}

				var th = jQuery( this ).parent();
				var id = 'customizer-repeater-' + awpbusinesspress_customizer_repeater_uniqid();
				...
				if (typeof    jQuery( this ).parent() !== 'undefined') {
					jQuery( this ).parent().hide(
						...
						function(){
							...
							var main_slider_items = jQuery( "#customize-control-awpbusinesspress_main_slider_content .customizer-repeater-general-control-repeater-container" ).length
							if (main_slider_items < 3) {
								jQuery( "#customize-control-awpbusinesspress_slider_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var theme_info_items = jQuery( "#customize-control-awpbusinesspress_top_info_content .customizer-repeater-general-control-repeater-container" ).length
							if (theme_info_items < 5) {
								jQuery( "#customize-control-awpbusinesspress_top_info_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var theme_service_items = jQuery( "#customize-control-awpbusinesspress_service_content .customizer-repeater-general-control-repeater-container" ).length
							if (theme_service_items < 4) {
								jQuery( "#customize-control-awpbusinesspress_service_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var theme_funfact_items = jQuery( "#customize-control-awpbusinesspress_funfact_content .customizer-repeater-general-control-repeater-container" ).length
							if (theme_funfact_items < 4) {
								jQuery( "#customize-control-awpbusinesspress_funfact_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var theme_team_items = jQuery( "#customize-control-awpbusinesspress_team_content .customizer-repeater-general-control-repeater-container" ).length
							if (theme_team_items < 4) {
								jQuery( "#customize-control-awpbusinesspress_team_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var project_items = jQuery( "#customize-control-awpbusinesspress_project_content .customizer-repeater-general-control-repeater-container" ).length
							if (project_items < 5) {
								jQuery( "#customize-control-awpbusinesspress_project_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var testimonial_items = jQuery( "#customize-control-awpbusinesspress_testimonial_content .customizer-repeater-general-control-repeater-container" ).length
							if (testimonial_items < 4) {
								jQuery( "#customize-control-awpbusinesspress_testimonial_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
							var client_items = jQuery( "#customize-control-awpbusinesspress_client_content .customizer-repeater-general-control-repeater-container" ).length
							if (client_items < 4) {
								jQuery( "#customize-control-awpbusinesspress_client_upgrade .awpbusinesspress-upgrade-pro-message" ).hide();
							}
		...
		theme_conrols.on(
			...
			function (event) {
				...
				var th = jQuery( this ).parent();
				var id = 'customizer-repeater-social-repeater-' + awpbusinesspress_customizer_repeater_uniqid();
				if (typeof th !== 'undefined') {
		...
		theme_conrols.on(
			...
			function (event) {
				...
				th.remove();
				awpbusinesspress_customizer_repeater_refresh_social_icons( repeater );
				return false;
			}
		);
...
function awpbusinesspress_escapeHtml(string) {
	'use strict';
