...
/**
 * Title: Content 006
 * Slug: the-fundraiser/content-006
 * Categories: content
 */
?>
...
<div class="wp-block-group alignfull has-mono-4-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--superbspacing-xlarge);padding-right:var(--wp--preset--spacing--superbspacing-small);padding-bottom:var(--wp--preset--spacing--superbspacing-xlarge);padding-left:var(--wp--preset--spacing--superbspacing-small)"><!-- wp:group {"align":"wide","style":{"spacing":{"blockGap":"var:preset|spacing|superbspacing-xsmall"}},"layout":{"type":"constrained","contentSize":"700px"}} -->
  <div class="wp-block-group alignwide"><!-- wp:separator {"className":"is-style-default","backgroundColor":"mono-3"} -->
    ...
    <h2 class="wp-block-heading has-text-align-center has-contrast-color has-text-color has-superbfont-xlarge-font-size"><?php esc_html_e("Our Mission & Values", "the-fundraiser"); ?></h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group has-mono-3-background-color has-background has-superbfont-medium-font-size" style="margin-top:var(--wp--preset--spacing--superbspacing-xxsmall);margin-bottom:var(--wp--preset--spacing--superbspacing-xxsmall);padding-top:var(--wp--preset--spacing--superbspacing-small);padding-right:var(--wp--preset--spacing--superbspacing-small);padding-bottom:var(--wp--preset--spacing--superbspacing-small);padding-left:var(--wp--preset--spacing--superbspacing-small)"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"24px"},"elements":{"link":{"color":{"text":"var:preset|color|mono-1"}}},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"mono-1"} -->
      <p class="has-text-align-left has-mono-1-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;font-size:24px"><?php esc_html_e("Transparency First", "the-fundraiser"); ?></p>
      <!-- /wp:paragraph -->

      <!-- wp:paragraph {"style":{"typography":{"fontSize":"24px"},"elements":{"link":{"color":{"text":"var:preset|color|mono-1"}}},"spacing":{"margin":{"top":"var:preset|spacing|superbspacing-xxsmall"}}},"textColor":"mono-1","fontSize":"superbfont-small"} -->
      <p class="has-mono-1-color has-text-color has-link-color has-superbfont-small-font-size" style="margin-top:var(--wp--preset--spacing--superbspacing-xxsmall);font-size:24px"><?php esc_html_e("dolor sit amet, consectetur adipiscing elit. Suspendisse eget dictum tellus, at consequat eros. Vestibulum id vestibulum augue. Maecenas et placerat diam, sit amet ullamcorper massa.", "the-fundraiser"); ?></p>
      <!-- /wp:paragraph -->
    </div>
    <!-- /wp:group -->
    ...
    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|superbspacing-small","bottom":"var:preset|spacing|superbspacing-small","left":"var:preset|spacing|superbspacing-small","right":"var:preset|spacing|superbspacing-small"},"margin":{"top":"var:preset|spacing|superbspacing-xxsmall","bottom":"var:preset|spacing|superbspacing-xxsmall"}}},"backgroundColor":"mono-3","fontSize":"superbfont-medium","layout":{"type":"constrained"}} -->
    <div class="wp-block-group has-mono-3-background-color has-background has-superbfont-medium-font-size" style="margin-top:var(--wp--preset--spacing--superbspacing-xxsmall);margin-bottom:var(--wp--preset--spacing--superbspacing-xxsmall);padding-top:var(--wp--preset--spacing--superbspacing-small);padding-right:var(--wp--preset--spacing--superbspacing-small);padding-bottom:var(--wp--preset--spacing--superbspacing-small);padding-left:var(--wp--preset--spacing--superbspacing-small)"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"24px"},"elements":{"link":{"color":{"text":"var:preset|color|mono-1"}}},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"mono-1"} -->
      <p class="has-text-align-left has-mono-1-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;font-size:24px"><?php esc_html_e("Local Impact", "the-fundraiser"); ?></p>
      <!-- /wp:paragraph -->
    ...
    <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|superbspacing-small","bottom":"var:preset|spacing|superbspacing-small","left":"var:preset|spacing|superbspacing-small","right":"var:preset|spacing|superbspacing-small"},"margin":{"top":"var:preset|spacing|superbspacing-xxsmall","bottom":"var:preset|spacing|superbspacing-xxsmall"}}},"backgroundColor":"mono-3","fontSize":"superbfont-medium","layout":{"type":"constrained"}} -->
    <div class="wp-block-group has-mono-3-background-color has-background has-superbfont-medium-font-size" style="margin-top:var(--wp--preset--spacing--superbspacing-xxsmall);margin-bottom:var(--wp--preset--spacing--superbspacing-xxsmall);padding-top:var(--wp--preset--spacing--superbspacing-small);padding-right:var(--wp--preset--spacing--superbspacing-small);padding-bottom:var(--wp--preset--spacing--superbspacing-small);padding-left:var(--wp--preset--spacing--superbspacing-small)"><!-- wp:paragraph {"align":"left","style":{"typography":{"fontSize":"24px"},"elements":{"link":{"color":{"text":"var:preset|color|mono-1"}}},"spacing":{"margin":{"top":"0","bottom":"0"}}},"textColor":"mono-1"} -->
      <p class="has-text-align-left has-mono-1-color has-text-color has-link-color" style="margin-top:0;margin-bottom:0;font-size:24px"><?php esc_html_e("Sustainable Results", "the-fundraiser"); ?></p>
      <!-- /wp:paragraph -->
