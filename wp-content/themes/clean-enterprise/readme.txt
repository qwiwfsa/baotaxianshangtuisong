...
You can check our Theme Instructions at https://catchthemes.com/themes/clean-enterprise in the Theme Instructions Tab.

= Where can I find theme demo? =

You can check our Theme Demo at https://catchthemes.com/demo/clean-enterprise/
...
= 2.2.1 (Released: December 14, 2025) =
* Updated: WordPress 6.9 ready

= 2.2 (Released: June 17, 2025) =
* Added: Discord, Line, Tel, RSS, Telegram, Twitter X, Tiktok, Bluesky, and Threads icons
* Bug Fixed: Secondary menu close and dropdown toggle click issue in mobile
* Updated: Font Awesome to version 6.7.2
* Updated: About admin CSS for changelog display
* Updated: WordPress 6.8 ready

= 2.1.3 (Released: June 13, 2024) =
* Updated: WordPress 6.5 ready

= 2.1.2 (Released: February 21, 2024) =
* Removed: Depreciated Instagram Feed Plugin recommendation

= 2.1.1 (Released: January 12, 2024) =
* Updated: WordPress 6.4 ready

= 2.1 (Released: September 15, 2023) =
* Bug Fixed: Removed unnecessary comment code in custom-header.php
* Updated: WordPress 6.3 ready

= 2.0.1 (Released: August 04, 2022) =
...
= 1.0.4 (Released: February 23, 2020) =
* Bug Fixed: HTML issue in searchform.php

= 1.0.3 (Released: January 14, 2020) =
* Bug Fixed: h1 tag issue
* Bug Fixed: Text color issue on Search
...
* Bug Fixed: Mobile Menu Scroll
* Bug Fixed: Header Video play/pause button issue

= 1.0.1 (Released: September 06, 2019) =
* Bug Fixed: Theme instructions URL
* Updated: Screenshot to fix the tagline

= 1.0 (Released: August 12, 2019) =
* Initial release

== Copyright ==

Clean Enterprise WordPress Theme, Copyright 2012-2025 Catchthemes.com
Clean Enterprise is distributed under the terms of the GNU General Public License v2
...
* Images
	...
	Header Image and Screenshot main image
		*https://stocksnap.io/photo/Q93BUD2Z3Z
