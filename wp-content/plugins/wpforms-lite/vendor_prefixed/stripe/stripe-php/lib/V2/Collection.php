 ...
 */
class Collection extends \WPForms\Vendor\Stripe\StripeObject implements \Countable, \IteratorAggregate
{
    const OBJECT_NAME = 'list';
    use \WPForms\Vendor\Stripe\ApiOperations\Request;
    /**
     * @return string the base URL for the given class
     */
    public static function baseUrl()
    {
        return \WPForms\Vendor\Stripe\Stripe::$apiBase;
    }
    /**
     * @return mixed
     */
    ...
    public function autoPagingIterator()
    {
        ...
        while (\true) {
            ...
            $obj = \WPForms\Vendor\Stripe\Util\Util::convertToStripeObject($response, $opts, 'v2');
