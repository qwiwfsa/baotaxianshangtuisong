...
use WPForms\Vendor\Square\Models\BulkDeleteMerchantCustomAttributesResponse;
...
use WPForms\Vendor\Square\Models\DeleteMerchantCustomAttributeDefinitionResponse;
...
class MerchantCustomAttributesApi extends BaseApi
{
     ...
     */
    public function listMerchantCustomAttributeDefinitions(?string $visibilityFilter = null, ?int $limit = null, ?string $cursor = null) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/merchants/custom-attribute-definitions')->auth('global')->parameters(QueryParam::init('visibility_filter', $visibilityFilter), QueryParam::init('limit', $limit), QueryParam::init('cursor', $cursor));
        $_resHandler = $this->responseHandler()->type(ListMerchantCustomAttributeDefinitionsResponse::class)->returnApiResponse();
     ...
     * @return ApiResponse Response from the API call
     */
    public function createMerchantCustomAttributeDefinition(CreateMerchantCustomAttributeDefinitionRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/merchants/custom-attribute-definitions')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(CreateMerchantCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/merchants/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key));
        $_resHandler = $this->responseHandler()->type(DeleteMerchantCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/merchants/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key), QueryParam::init('version', $version));
        $_resHandler = $this->responseHandler()->type(RetrieveMerchantCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function updateMerchantCustomAttributeDefinition(string $key, UpdateMerchantCustomAttributeDefinitionRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/merchants/custom-attribute-definitions/{key}')->auth('global')->parameters(TemplateParam::init('key', $key), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(UpdateMerchantCustomAttributeDefinitionResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/merchants/custom-attributes/bulk-delete')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(BulkDeleteMerchantCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/merchants/custom-attributes/bulk-upsert')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(BulkUpsertMerchantCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function listMerchantCustomAttributes(string $merchantId, ?string $visibilityFilter = null, ?int $limit = null, ?string $cursor = null, ?bool $withDefinitions = \false) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/merchants/{merchant_id}/custom-attributes')->auth('global')->parameters(TemplateParam::init('merchant_id', $merchantId), QueryParam::init('visibility_filter', $visibilityFilter), QueryParam::init('limit', $limit), QueryParam::init('cursor', $cursor), QueryParam::init('with_definitions', $withDefinitions));
        $_resHandler = $this->responseHandler()->type(ListMerchantCustomAttributesResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/merchants/{merchant_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('merchant_id', $merchantId), TemplateParam::init('key', $key));
        $_resHandler = $this->responseHandler()->type(DeleteMerchantCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function retrieveMerchantCustomAttribute(string $merchantId, string $key, ?bool $withDefinition = \false, ?int $version = null) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/merchants/{merchant_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('merchant_id', $merchantId), TemplateParam::init('key', $key), QueryParam::init('with_definition', $withDefinition), QueryParam::init('version', $version));
        $_resHandler = $this->responseHandler()->type(RetrieveMerchantCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
    /**
     ...
     * @return ApiResponse Response from the API call
     */
    public function upsertMerchantCustomAttribute(string $merchantId, string $key, UpsertMerchantCustomAttributeRequest $body) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/merchants/{merchant_id}/custom-attributes/{key}')->auth('global')->parameters(TemplateParam::init('merchant_id', $merchantId), TemplateParam::init('key', $key), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
        $_resHandler = $this->responseHandler()->type(UpsertMerchantCustomAttributeResponse::class)->returnApiResponse();
        return $this->execute($_reqBuilder, $_resHandler);
    }
}
