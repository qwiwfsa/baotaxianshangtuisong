...
use WPForms\Vendor\Square\Models\PublishInvoiceRequest;
use WPForms\Vendor\Square\Models\PublishInvoiceResponse;
use WPForms\Vendor\Square\Models\SearchInvoicesRequest;
use WPForms\Vendor\Square\Models\SearchInvoicesResponse;
use WPForms\Vendor\Square\Models\UpdateInvoiceRequest;
...
class InvoicesApi extends BaseApi
{
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/invoices')->auth('global')->parameters(QueryParam::init('location_id', $locationId), QueryParam::init('cursor', $cursor), QueryParam::init('limit', $limit));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/invoices')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/invoices/search')->auth('global')->parameters(HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/invoices/{invoice_id}')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), QueryParam::init('version', $version));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::GET, '/v2/invoices/{invoice_id}')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::PUT, '/v2/invoices/{invoice_id}')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
     ...
     * @return ApiResponse Response from the API call
     */
    public function createInvoiceAttachment(string $invoiceId, ?CreateInvoiceAttachmentRequest $request = null, ?FileWrapper $imageFile = null) : ApiResponse
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/invoices/{invoice_id}/attachments')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), FormParam::init('request', $request)->encodingHeader('Content-Type', 'application/json; charset=utf-8'), FormParam::init('image_file', $imageFile)->encodingHeader('Content-Type', 'image/jpeg'));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::DELETE, '/v2/invoices/{invoice_id}/attachments/{attachment_id}')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), TemplateParam::init('attachment_id', $attachmentId));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/invoices/{invoice_id}/cancel')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
    ...
    {
        $_reqBuilder = $this->requestBuilder(RequestMethod::POST, '/v2/invoices/{invoice_id}/publish')->auth('global')->parameters(TemplateParam::init('invoice_id', $invoiceId), HeaderParam::init('Content-Type', 'application/json'), BodyParam::init($body));
