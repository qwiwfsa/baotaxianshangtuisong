...
`,J=(0,R.styled)(R.Box)(({theme:e})=>({position:"sticky",top:"-8px",padding:e.spacing(1,2),color:e.palette.text.tertiary,backgroundColor:e.palette.primary.contrastText})),q=(0,R.styled)("ul")`
	padding: 0;
`;var X=window.elementorV2.editorStyles;const Q=(0,n.createContext)(null),Z=()=>{const e=(0,n.useContext)(Q);if(!e)throw new Error("useCssClass must be used within a CssClassProvider");return e};function ee({children:e,...t}){return n.createElement(Q.Provider,{value:t},e)}const te=(0,R.styled)("div",{shouldForwardProp:e=>!["isOverridden","getColor"].includes(e)})`
	width: 5px;
	height: 5px;
	border-radius: 50%;
