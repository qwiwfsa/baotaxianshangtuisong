 ...
 * @returns {string}
 */
export const getHoverFieldOnHover = (field, props) =>
    isHoverMode() && isEnabled(field, props) ? getHoverField(field) : getFieldBaseName(field);
...
export const getValue = (field, props, defaultValue) =>
    1 === getFn(props, 'hover_enabled') && isEnabled(field, props)
 ...
 * @returns {*}
 */
export const getValueOnHover = (setting, props, defaultValue) =>
    isHoverMode() ? getValue(setting, props, defaultValue) : defaultValue;
 ...
 * @returns {*}
 */
export const getHoverOrNormalOnHover = (setting, props) =>
    getValueOnHover(setting, props, get(getFieldBaseName(setting), props));
 ...
 * @returns {*}
 */
export const getSplitValueOnHover = (setting, props, sep = undefined) =>
    isHoverMode() ? getSplitValue(setting, props, sep) : undefined;
 ...
 * @returns {*}
 */
export const getCompositeValue = (field, option, props) =>
    1 === getFn(props, 'hover_enabled') && isEnabled(option, props)
 ...
 * @returns {*}
 */
export const getCompositeValueOnHover = (field, option, props) =>
    isHoverMode() ? getCompositeValue(field, option, props) : undefined;
export const getCompositeFieldOnHover = (field, option, props) =>
    isHoverMode() && isEnabled(option, props) ? getHoverField(field) : getFieldBaseName(field);
