<?php
class DTQ_InlineNotice extends Divi_Torque_Lite_Module
{
	...
	public function get_fields()
	{
		$content = array(
			...
			'icon'        => array(
				...
				'description'     => esc_html__('Here you can select the icon you would like to use for your inline notice.', 'addons-for-divi'),
				'type'            => 'select_icon',
			...
			'title'       => array(
				'label'           => esc_html__('Title', 'addons-for-divi'),
				'description'     => esc_html__('Here you can define the title for your inline notice.', 'addons-for-divi'),
				'type'            => 'text',
			...
			'description' => array(
				'label'           => esc_html__('Description', 'addons-for-divi'),
				'description'     => esc_html__('Here you can define the description for your inline notice.', 'addons-for-divi'),
				'type'            => 'tiny_mce',
				'option_category' => 'basic_option',
				'dynamic_content' => 'text',
				'toggle_slug'     => 'content',
	...
	protected function apply_css($render_slug)
	{
		...
		$this->get_responsive_styles(
			'dismiss_size',
			'%%order_class%% .dtq-alert .dtq-alert-dismiss',
			array('primary' => 'font-size'),
			array('default' => '22px'),
			$render_slug
		);
		...
		if ($dismiss_color) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtq-alert-dismiss',
		...
		if ($dismiss_color_hover) {
			ET_Builder_Element::set_style(
				$render_slug,
				array(
					'selector'    => '%%order_class%% .dtq-alert-dismiss:hover',
