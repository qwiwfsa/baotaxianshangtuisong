<?php
class DTQ_Image_Compare extends Divi_Torque_Lite_Module
{
	...
	public function init()
	{
		...
		$this->vb_support = 'on';
		$this->name       = esc_html__('Before & After Slider', 'addons-for-divi');
		$this->icon_path  = $this->dtl_icon_path('before-after');
	...
	public function get_fields()
	{
		...
		return array(
			...
			'before_label_bg' => array(
				'label'        => esc_html__('Label Background', 'addons-for-divi'),
