<?php
class DTQ_Advanced_Divider extends Divi_Torque_Lite_Module
{
	...
	public function init()
	{
		...
		$this->name       = esc_html__('Separator', 'addons-for-divi');

		$this->icon_path  	= $this->dtl_icon_path('divider');
