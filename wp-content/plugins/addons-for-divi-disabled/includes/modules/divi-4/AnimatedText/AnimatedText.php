<?php
class DTQ_AnimatedText extends Divi_Torque_Lite_Module
{
	...
	public function init()
	{
		...
		$this->vb_support = 'on';
		$this->name       = esc_html__('Animated Text', 'addons-for-divi');
		$this->icon_path  	= $this->dtl_icon_path('text');
	...
	public function get_fields()
	{
		...
		return array_merge(
			...
			array(
				'__renderText'       => array(
					'type'                => 'computed',
					'computed_callback'   => array('DTQ_AnimatedText', 'static_text_render'),
	...
	public static function static_text_render($attrs, $content, $render_slug)
	{
		return $content;
	}
	...
	public function render($attrs, $content, $render_slug)
	{
		...
		if ('typed' === $animation_type) {
			wp_enqueue_script('divi-torque-lite-typed');
