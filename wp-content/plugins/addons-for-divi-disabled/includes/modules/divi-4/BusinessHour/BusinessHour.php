<?php
class DTQ_Business_Hour extends Divi_Torque_Lite_Module
{
	...
	public function init()
	{
		...
		$this->name      	= esc_html__('Business Hours', 'addons-for-divi');
		$this->icon_path  	= $this->dtl_icon_path('business-hours');
