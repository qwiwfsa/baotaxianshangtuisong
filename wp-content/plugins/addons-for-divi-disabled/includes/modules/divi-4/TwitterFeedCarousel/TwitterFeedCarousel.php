...
class DTQ_Twitter_Feed_Carousel extends Divi_Torque_Lite_Module
{
						...
						<div class="dtq-twitter-feed-author">
							...
							<?php if ($args['show_user_image'] == 'on') : ?>
								...
								<a class="dtq-twitter-feed-avatar-wrapper" href="<?php echo esc_url('https://twitter.com/' . $user_name); ?>">
									<img src="<?php echo esc_url($item['user']['profile_image_url_https']); ?>" alt="<?php echo esc_attr($item['user']['name']); ?>" class="dtq-twitter-feed-avatar">
								</a>
