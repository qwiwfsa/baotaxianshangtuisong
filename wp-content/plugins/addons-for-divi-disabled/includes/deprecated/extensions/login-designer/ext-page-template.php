...
if (!class_exists('DiviTorque_Login_Template')) :

	class DiviTorque_Login_Template
	{
		...
		public static function get_instance()
		{
			if (null === self::$instance) {
				self::$instance = new DiviTorque_Login_Template();
			}
...
add_action('plugins_loaded', array('DiviTorque_Login_Template', 'get_instance'));
