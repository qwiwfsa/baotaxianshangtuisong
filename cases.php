    ...
    <script>
        ...
        function changePage(newPage) {
            ...
            requestAnimationFrame(function() {
                ...
                if (grid) { grid.style.opacity = '1'; grid.style.transition = 'opacity 0.2s'; }
                ...
                return `
                    ...
                    <article class="case-card-enhanced" data-id="${caseItem.id}">
                        ...
                        <div class="case-card-content">
                            ...
                            <div class="case-card-tags">${(caseItem.tags && caseItem.tags.length > 0) ? caseItem.tags.slice(0, 3).map(t => `<span class="case-card-tag">${t}</span>`).join("") : ""}</div>
