...
try {
    ...
    $result = $db->query("SELECT id, title, company, amount, period, category, description, image, content, status, sort_order, created_at, updated_at FROM cases WHERE 1=1 ORDER BY sort_order ASC, id DESC");
