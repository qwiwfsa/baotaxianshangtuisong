...
<html lang="zh-CN"><head>
    ...
    <meta name="keywords" content="<?php echo htmlspecialchars(!empty($page_keywords) ? $page_keywords : '常见问题,亮资业务,过桥资金,摆账业务,应收账款融资,FAQ'); ?>">
...
<a href="index.html" class="logo" aria-label="Yao资金网首页"><img src="..//uploads/logo/logo_20260505_122045_69f9c47d515d1.png?v=20260502040820" alt="Yao资金网" style="height:48px;width:auto;"></a>
    ...
    <script>
        ...
        var FAQ_DEFAULT_SEO = {
            title: '常见问题 - Yao资金网',
            keywords: '常见问题,亮资业务,过桥资金,摆账业务,应收账款融资,FAQ',
